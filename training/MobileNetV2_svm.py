#!/usr/bin/env python3
"""
MobileNetV2 + SVM Training Script
"""
import os
...
def train_mobilenetv2_svm():
    """Train MobileNetV2 + SVM model"""
    
    print("\n" + "="*80)
    print("🚀 TRAINING: MobileNetV2 + SVM")
    print("="*80 + "\n")
    ...
    encoder_path = MODEL_DIR / "mobilenetv2_label_encoder.pkl"
    ...
    report = generate_report(
        ...
        notes='Lightweight model - Feature extraction using pretrained MobileNetV2, classification with SVM'
    )
