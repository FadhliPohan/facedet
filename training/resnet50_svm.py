...
def train_resnet50_svm():
    """Train ResNet50 + SVM model"""
    
    print("\n" + "="*80)
    print("🚀 TRAINING: ResNet50 + SVM")
    print("="*80 + "\n")
    ...
    encoder_path = MODEL_DIR / "resnet50_label_encoder.pkl"
    ...
    report = generate_report(
        ...
        notes='Feature extraction using pretrained ResNet50, classification with SVM'
    )
